...
export default function Header() {
  ...
  return (
    <motion.div
      ...
      className="w-full border-blue-200 border right-[50%] translate-x-[50%] fixed top-5 z-999999 rounded-2xl transition-all duration-200 h-20 bg-[#ffffff76] backdrop-blur-3xl shadow-[0px_0px_10px_5px] shadow-[#0037ff1e] flex items-center justify-between p-5"
    >
